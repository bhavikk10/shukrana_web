...
const heroEnd = '{/* Heritage Marquee */}';
      ...
      <AnimatePresence>
        ...
        >
          <section className="relative min-h-[90vh] lg:min-h-screen flex items-center overflow-hidden bg-[radial-gradient(ellipse_at_center,_#065f4b_0%,_#044738_40%,_#011a14_100%)]">
            ...
            <div className="w-full h-full flex flex-col lg:flex-row relative z-10 mx-auto max-w-[1600px]">
              
              {/* Left Side: Text Section (40%) */}
              <div className="w-full lg:w-[45%] flex flex-col justify-center px-8 lg:px-16 xl:px-24 py-20 relative z-20 h-full mt-10 lg:mt-0">
                ...
                >
                  <p className="font-subheading text-gold tracking-[4px] uppercase text-xs md:text-sm mb-6 font-bold zardozi-shimmer flex items-center gap-4">
                    <span className="w-8 h-[1px] bg-gold/50 block"></span>
                    THE ROYAL EDIT — SS/26
                  </p>
                  
                  <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl xl:text-8xl text-ivory mb-8 leading-[1.1] drop-shadow-lg zardozi-shimmer">
                    The Royal <br className="hidden md:block"/>Trousseau
                  </h1>
                  
                  <p className="font-body text-parchment/90 text-lg md:text-xl lg:text-2xl mb-12 italic leading-relaxed max-w-lg font-light drop-shadow-md">
                    A legacy of hand-woven blessings, crafted for the modern monarch.
                  </p>

                  <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                    <Link to="/collections" className="group relative overflow-hidden bg-[#D4AF37] text-emerald px-8 py-4 flex items-center gap-3 transition-all duration-300 shadow-[0_0_15px_rgba(212,175,55,0.2)] hover:shadow-[0_0_25px_rgba(212,175,55,0.6)]">
                      <div className="absolute inset-0 bg-white/20 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-in-out"></div>
                      <span className="font-subheading tracking-widest text-sm font-bold uppercase relative z-10">Explore the Collection</span>
                      <svg width="24" height="24" viewBox="0 0 24 40" fill="none" className="w-3 h-5 text-emerald opacity-0 group-hover:opacity-100 -translate-y-2 group-hover:translate-y-0 transition-all duration-300 -rotate-12 relative z-10">
              ...
              <div className="w-full h-[60vh] relative z-10 block lg:hidden px-6 pb-12 mt-8">
                 <div className="w-full h-full shape-arch bg-burgundy overflow-hidden border border-gold/40 shadow-[0_10px_30px_rgba(0,0,0,0.4)]">
                    <img 
